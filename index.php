...
echo  $errMSG; ?>
  ...
  ?>
            ...
            <input  type="email" name="email"  class="form-control col-md-6 mb-3" placeholder= "Your Email" value="<?php echo $email; ?>"  maxlength="40" />
           ...
           <span  class="text-danger"><?php  echo $passError; ?></span>
            <hr>
            <button class="col-md-2" type="submit" name= "btn-login">Sign In</button>
